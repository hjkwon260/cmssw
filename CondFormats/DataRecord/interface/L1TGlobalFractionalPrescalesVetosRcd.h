...
//
#ifndef CondFormatsDataRecord_L1TGlobalFractionalPrescalesVetos_h
#define CondFormatsDataRecord_L1TGlobalFractionalPrescalesVetos_h

#include "FWCore/Framework/interface/EventSetupRecordImplementation.h"

class L1TGlobalFractionalPrescalesVetosRcd : public edm::eventsetup::EventSetupRecordImplementation<L1TGlobalFractionalPrescalesVetosRcd> {
};
