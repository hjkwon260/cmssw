#ifndef RecoMuon_L2MuonSeedGenerator_L2MuonSeedGeneratorFromL1THJ_H
#define RecoMuon_L2MuonSeedGenerator_L2MuonSeedGeneratorFromL1THJ_H
...
class L2MuonSeedGeneratorFromL1THJ : public edm::stream::EDProducer<> {
public:
  /// Constructor
  explicit L2MuonSeedGeneratorFromL1THJ(const edm::ParameterSet &);

  /// Destructor
  ~L2MuonSeedGeneratorFromL1THJ() override;
