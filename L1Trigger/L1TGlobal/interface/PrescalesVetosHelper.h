...
namespace l1t {
  ...
  public:
    ...
    inline const std::vector<std::vector<float> >& prescaleTable() const { return read_->prescale_table_; };
    void setPrescaleFactorTable(std::vector<std::vector<float> > value) {
      check_write();
